...
type SearchClient interface {
	...
	Search(ctx context.Context, in *ComicsRequest, opts ...grpc.CallOption) (*ComicsResponse, error)
	SearchIndex(ctx context.Context, in *ComicsRequest, opts ...grpc.CallOption) (*ComicsResponse, error)
}
...
func (c *searchClient) Search(ctx context.Context, in *ComicsRequest, opts ...grpc.CallOption) (*ComicsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *searchClient) SearchIndex(ctx context.Context, in *ComicsRequest, opts ...grpc.CallOption) (*ComicsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ComicsResponse)
...
type SearchServer interface {
	...
	Search(context.Context, *ComicsRequest) (*ComicsResponse, error)
	SearchIndex(context.Context, *ComicsRequest) (*ComicsResponse, error)
...
func (UnimplementedSearchServer) Search(context.Context, *ComicsRequest) (*ComicsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Search not implemented")
}
func (UnimplementedSearchServer) SearchIndex(context.Context, *ComicsRequest) (*ComicsResponse, error) {
...
func _Search_Search_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchServer).Search(ctx, req.(*ComicsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Search_SearchIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchServer).SearchIndex(ctx, req.(*ComicsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
